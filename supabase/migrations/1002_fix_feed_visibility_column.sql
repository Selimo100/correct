-- MIGRATION: 1002_fix_feed_visibility_column.sql
-- Update fn_search_bets to return the visibility column so the UI can show the Private badge
...
RETURNS TABLE (
  ...
  status TEXT,
  resolution BOOLEAN,
  visibility TEXT, -- Added this column
