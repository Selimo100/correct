-- Migration 015: Search Bets V2 supporting Audience Scopes

DROP FUNCTION IF EXISTS public.fn_search_bets_v2;
    ...
    AND (
       ...
       CASE 
          ...
          WHEN p_audience_scope = 'ALL' THEN
             (b.audience = 'PUBLIC' OR b.creator_id = v_user_id) -- Fallback for basic view
